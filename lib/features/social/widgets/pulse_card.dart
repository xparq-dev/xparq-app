...
class _PulseCardState extends ConsumerState<PulseCard> {
  ...
  void _toggleWarpState(String uid) async {
    ...
    try {
      await ref.read(pulseRepositoryProvider).toggleWarp(widget.pulse.id, uid);
      if (mounted) {
          ...
          children: [
            ...
            if (isOwner) ...[
              ListTile(
                ...
                title: Text(
                  AppLocalizations.of(context)!.pulseDeletePulse,
              ...
              ListTile(
                leading: Icon(Icons.flag_outlined, color: Colors.orangeAccent),
                title: Text(
  ...
  void _deletePulse() async {
    ...
    try {
      ...
      final _ = ref.refresh(orbitFeedProvider);
