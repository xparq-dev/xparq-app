 ...
 */
exports.onMessageCreated = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        const messaging = (0, firebaseAdmin_1.getMessaging)();
        if (!messaging) {
        ...
        const senderDisplayName = (sender === null || sender === void 0 ? void 0 : sender.xparq_name) || "An iXPARQ";
        ...
        if (message_type === "image")
            bodySuffix = "Sent an image 🖼️";
        if (message_type === "video")
            bodySuffix = "Sent a video 📹";
