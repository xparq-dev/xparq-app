  ...
  Widget build(BuildContext context) {
    ...
    final scaffold = Scaffold(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Re-scanning Orbit... 🛰️'),
      ...
      body: RefreshIndicator(
        displacement: 20.0,
        onRefresh: () async {
          // Reset the stream to force a clean sync if the user pulls down
          ref.invalidate(orbitFeedProvider);
          try {
            await ref.read(orbitFeedProvider.future);
          } catch (_) {}
        },
        color: const Color(0xFF4FC3F7),
        backgroundColor: Theme.of(context).scaffoldBackgroundColor,
