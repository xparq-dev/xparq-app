...
class SignalChatAppBar extends ConsumerWidget implements PreferredSizeWidget {
  ...
  void _showGlassMenu(BuildContext context, WidgetRef ref,
      {required bool isGroupMenu}) {
    showGeneralDialog(
      context: context,
                  ...
                  child: SizedBox(
                    ...
                    child: GlassCard(
                      ...
                      child: Column(
                        ...
                        children: isGroupMenu
                            ? _buildGroupItems(context, ref)
                            : _buildPrivateItems(context, ref),
                      ),
                    ),
                  ),
                ),
